...
const translations: FilePickerTranslations = {
    ...
    error: {
        ...
        internal_error_during_upload: 'Непредвиденая ошибка при обработке файла. Возможно файл поврежден.',
        internal_error_in_xhr: 'Непредвиденая ошибка при отправке файла.',
